...
export default function ProductDetailClient({
  ...
  return (
    <section className="bg-[#f3f4f6] py-10 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 mb-5">
              ...
              {allImages.map((img, idx) => (
                <div
                  ...
                  className={`w-20 h-20 rounded cursor-pointer overflow-hidden ${
                    manualSelectedIndex === idx ? "ring-2 ring-purple-600" : ""
                  }`}
                >
                  <Image
                    src={img}
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4 items-center flex-wrap">
            {!isOutOfStock && (
              <div className="flex items-center border rounded-md h-[44px] overflow-hidden">
                <button
      ...
      {/* This section displays related products, which are passed as a prop */}
