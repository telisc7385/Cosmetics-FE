...
//                 ₹{selectedVariant ? (Number(selectedVariant.base_price) || 0).toFixed(2) : (Number(product.basePrice) || 0).toFixed(2)}
//               </span>
//               <span className="text-sm text-gray-400 line-through">
//                 {/* ₹{parseFloat(product.sellingPrice).toFixed(2)} */}

//                 ₹{selectedVariant ? (Number(selectedVariant.selling_price) || 0).toFixed(2) : (Number(product.sellingPrice) || 0).toFixed(2)}
//               </span>
//             </div>
//           </div>
//         </Link>
