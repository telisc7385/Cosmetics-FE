      ...
      <div className="min-h-screen bg-gray-50 py-12 px-2 sm:px-6 lg:px-8 flex items-center justify-center">
        ...
        <div className="w-full max-w-7xl bg-white shadow-md rounded-lg p-4 sm:p-10 lg:p-8">
          ...
          <p className="mb-6 text-base text-gray-700 leading-relaxed">
            This website is operated by GlowUp Cosmetics. Throughout the site,
            the terms “we”, “us” and “our” refer to GlowUp Cosmetics. GlowUp
            Cosmetics offers this website, including all information, tools and
          ...
          {/* Reduced from text-2xl to text-xl */}
          <h2 className="text-xl font-bold text-gray-900 mb-4">
            SECTION 4 – MODIFICATIONS TO THE SERVICE, PRICES & OTHER FEES.
          </h2>
          <p className="mb-6 text-base text-gray-700 leading-relaxed">
            Prices for our products are subject to change without notice as it
            depends on store pricing. Online pricing is completely different
            from store as there will be a hike to ensure payments to all
            employees and try to be profitable.
          </p>
          <p className="mb-6 text-base text-gray-700 leading-relaxed">
            Service Fees @ around 3-5% are charged along with Min tipping option
            enabled when req. This option might be made mandatory for customers
            who choses to never tip or during hardship times to ensure fair pay.
          </p>
          <p className="mb-6 text-base text-gray-700 leading-relaxed">
          ...
          <p className="mb-6 text-base text-gray-700 leading-relaxed">
            ...
            governed by our Privacy Policy. Please check our Privacy policy.
          </p>
          ...
          {/* Reduced from text-2xl to text-xl */}
          <h2 className="text-xl font-bold text-gray-900 mb-4">
            SECTION 12 – PROMO CODES REDEMPTION - TERMS & LIMITATIONS
          </h2>
          <p className="mb-6 text-base text-gray-700 leading-relaxed">
            Promo Codes can only be redeemed online & are not applicable to
            partnered store physical purchases.
          </p>
          <p className="mb-6 text-base text-gray-700 leading-relaxed">
            Only one (1) promo code may be redeemed per user account/per
            household/per promotion.
          </p>
          <p className="mb-6 text-base text-gray-700 leading-relaxed">
            Promo codes may have a validation period.
          </p>
          <p className="mb-6 text-base text-gray-700 leading-relaxed">
          ...
          {/* Reduced from text-2xl to text-xl */}
          <h2 className="text-xl font-bold text-gray-900 mb-4">
            SECTION 12A – REFER A FRIEND – TERMS & LIMITATIONS
          </h2>
          <p className="mb-6 text-base text-gray-700 leading-relaxed">
            Referrals are limited to one per household.
          </p>
          <p className="mb-6 text-base text-gray-700 leading-relaxed">
            Multiple referrals from the same household with different
            emails/contact numbers are not valid.
          </p>
          <p className="mb-6 text-base text-gray-700 leading-relaxed">
            Repeated offenders’ accounts will be blocked and service to their
            address will be suspended for 6 months to 1 year.
          </p>
          ...
          <p className="mb-6 text-base text-gray-700 leading-relaxed">
            ...
            case shall GlowUp Cosmetics, our directors, officers, employees,
          ...
          <p className="mb-6 text-base text-gray-700 leading-relaxed">
            You agree to indemnify, defend and hold harmless GlowUp Cosmetics
          ...
          <p className="mb-6 text-base text-gray-700 leading-relaxed">
            ...
            accordance with the laws of 100Schuyler Ave Kearny New Jersey US
            07032.
          </p>
